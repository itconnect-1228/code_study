...
describe('useAuth', () => {
  ...
  describe('login', () => {
    it('calls authService.login and updates store on success', async () => {
      const mockUser = { id: '123', email: 'test@example.com', skillLevel: 'beginner' }
  ...
  describe('refresh', () => {
    it('calls authService.refresh and updates store on success', async () => {
      const mockUser = { id: '123', email: 'test@example.com', skillLevel: 'intermediate' }
  ...
  describe('isLoading', () => {
    it('sets isLoading during login', async () => {
      ...
      // Resolve login
      await act(async () => {
        resolveLogin!({ id: '123', email: 'test@example.com', skillLevel: 'beginner' })
        await loginPromise
      })

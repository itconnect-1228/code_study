...
4. Update OpenAPI spec in `specs/001-code-learning-platform/contracts/api-spec.yaml`
...
- Gemini 2.5 Flash has generous rate limits for most use cases
...
- Review spec: `specs/001-code-learning-platform/spec.md`
